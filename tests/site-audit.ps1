...
Require-Match 'menu-family-tabs' 'Brew/Butter controls should be compact tabs, not oversized cards'
Require-Match 'id="mobileActionBar"' 'Sticky mobile action bar is missing'
Require-Match 'id="mobileActionOrder"' 'Mobile order action is missing'
Require-Match 'id="mobileActionWhatsapp"' 'Mobile WhatsApp action is missing'
Require-Match 'id="mobileActionDirections"' 'Mobile directions action is missing'
...
Require-Match 'deliveryMode' 'Pickup and delivery choice is missing'
Require-Match 'Cash on delivery' 'COD payment note is missing'
Require-Match 'Payment: Cash on delivery' 'WhatsApp order should include COD payment'
Require-Match 'Fulfillment:' 'WhatsApp order should include pickup or delivery'
...
Require-Match 'Popular' 'Best-seller tags are missing'
Require-Match 'High protein' 'High-protein tags are missing'
...
Require-Match 'Beirut Downtown' 'Branch chooser should show the Downtown area'
Require-Match 'Riad El Solh Street' 'Branch chooser should show exact Downtown location'
Require-Match 'Free Wi-Fi' 'Free Wi-Fi note is missing'
Require-Match 'study area' 'Study area note is missing'
Require-Match 'Mon - Sun, 8 AM - 11 PM' 'Opening hours are missing'
Require-Match 'application/ld\+json' 'Local SEO schema is missing'
Require-Match 'openingHoursSpecification' 'Opening hours schema is missing'
Require-Match 'paymentAccepted' 'Payment schema is missing'
Require-Match 'trackEvent' 'Analytics event hooks are missing'
...
Forbid-Match 'menu-family-card' 'Oversized Brew/Butter cards should be replaced with compact controls'
Forbid-Match 'menu-photo-strip' 'Menu section should be text-only for now'
Forbid-Match 'productImage|product-media' 'Menu item cards should not show photos for now'
